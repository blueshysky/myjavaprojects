...
public class BankRecords implements Client {
	...
	/*
	 * id {string} age {numeric} sex {FEMALE,MALE} region
	 * {INNER_CITY,TOWN,RURAL,SUBURBAN} income {numeric} married {NO,YES} children
	 * {0,1,2,3} car {NO,YES} save_act {NO,YES} current_act {NO,YES} mortgage
	 * {NO,YES} pep {YES,NO}
	 */
	private String id;
	private int age;
